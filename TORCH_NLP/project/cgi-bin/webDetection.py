...
def load_model_and_vocab_for_category(category):
    model_paths = {
        ...
        "생활&문화": r"C:\Hwan\TORCH_NLP\project\cgi-bin\models\best_model.pth",
        "IT&과학": "/absolute/path/to/it_science_model.pth",
        "정치": "/absolute/path/to/politics_model.pth"
    }

    vocab_paths = {
        "경제": "/absolute/path/to/economy_vocab.pkl",
        "생활&문화": r"C:\Hwan\TORCH_NLP\project\cgi-bin\wordDict\word_culture.pkl",
        "IT&과학": "/absolute/path/to/it_science_vocab.pkl",
